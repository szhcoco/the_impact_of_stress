...
async function loadData() {
    ...
    for (let student = 1; student <= studentCount; student++) {
        ...
        for (const test of tests) {
            ...
            const avg_TEMP = inTestTEMP.reduce((sum, v) => sum + v, 0) / inTestTEMP.length;
...
export async function renderScatterPlot() {
    ...
    dots
        ...
        .on('mouseover', (event, d) => {
            ...
            TEMP.createPlot(svg, 'S'+d.student, d.test);
            // TEMP.createPlot(svg2, 'S'+d.student, 'Midterm 2');
            // TEMP.createPlot(svg3, 'S'+d.student, 'Final');
        });
