...
async function loadData() {
    ...
    for (let student = 1; student <= studentCount; student++) {
        ...
        const avg_hr = allTestHR.reduce((sum, v) => sum + v, 0) / allTestHR.length;
...
async function renderScatterPlot() {
    ...
    dots
        ...
        .on('mouseover', (event, d) => {
            ...
            HR.createPlot(svg1, 'dataset/S'+d.student+'_processed/Midterm 1/HR.csv');
            HR.createPlot(svg2, 'dataset/S'+d.student+'_processed/Midterm 2/HR.csv');
            HR.createPlot(svg3, 'dataset/S'+d.student+'_processed/Final/HR.csv');
        });
